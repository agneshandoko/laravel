            ...
            <!-- /.box -->
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Rad Check Table</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                    <a href="../public/radcheck/create"><button type="button" class="btn btn-block btn-info">Add Rad Check Data</button></a>
