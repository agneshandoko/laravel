            ...
            <!-- /.box -->
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Rad Check Form</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                    {!! Form::open(['action' => 'RadCheckController@store', 'method' => 'POST']) !!}
                        <div class="form-group">
                            {{Form::label('id', 'Rad Check Id')}}
                            {{Form::number('id', '', ['class' => 'form-control', 'placeholder' => 'Rad Check Id (Fill with number)'])}}
                        </div>
                        <div class="form-group">
                            {{Form::label('username', 'Rad Check Username')}}
                            {{Form::text('username', '', ['class' => 'form-control', 'placeholder' => 'Rad Check Username'])}}
                        </div>
                        <div class="form-group">
