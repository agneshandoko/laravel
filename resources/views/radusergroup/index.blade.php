            ...
            <!-- /.box -->
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Rad User Group Table</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                    <a href="../public/radusergroup/create"><button type="button" class="btn btn-block btn-info">Add Rad User Group</button></a>
