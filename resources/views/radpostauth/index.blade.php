            ...
            <!-- /.box -->
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Rad Post Auth Table</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                    <a href="../public/radpostauth/create"><button type="button" class="btn btn-block btn-info">Add Rad Post Auth</button></a>
