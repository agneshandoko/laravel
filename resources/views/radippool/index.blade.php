            ...
            <!-- /.box -->
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Rad Ip Pool Table</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                    <a href="../public/radippool/create"><button type="button" class="btn btn-block btn-info">Add Ip Pool Data</button></a>
