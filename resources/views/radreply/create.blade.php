            ...
            <!-- /.box -->
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Rad Reply Form</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                    {!! Form::open(['action' => 'RadReplyController@store', 'method' => 'POST']) !!}
                        <div class="form-group">
                            {{Form::label('id', 'Rad Reply Id')}}
                            {{Form::number('id', '', ['class' => 'form-control', 'placeholder' => 'Rad Reply Id (Fill with number)'])}}
                        </div>
                        <div class="form-group">
                            {{Form::label('username', 'Rad Reply Username')}}
                            {{Form::text('username', '', ['class' => 'form-control', 'placeholder' => 'Rad Reply Username'])}}
                        </div>
                        <div class="form-group">
