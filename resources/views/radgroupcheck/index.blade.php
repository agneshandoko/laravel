            ...
            <!-- /.box -->
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Rad Group Check Table</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                    <a href="../public/radgroupcheck/create"><button type="button" class="btn btn-block btn-info">Add Rad Group Check</button></a>
