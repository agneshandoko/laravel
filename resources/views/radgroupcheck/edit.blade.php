...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Form
            <small>Rad Group Check Edit Form</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <!-- /.box -->
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Rad Group Check Edit Form</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                    {!! Form::open(['action' => ['RadGroupCheckController@update', $radData->id], 'method' => 'POST']) !!}
                        <div class="form-group">
                            {{Form::label('id', 'Rad Group Check Id')}}
                            {{Form::number('id', $radData->id, ['class' => 'form-control', 'placeholder' => 'Rad Group Check Id (Fill with number)'])}}
                        </div>
                        <div class="form-group">
                            {{Form::label('groupname', 'Rad Group Check Username')}}
                            {{Form::text('groupname', $radData->groupname , ['class' => 'form-control', 'placeholder' => 'Rad Group Check Username'])}}
                        </div>
                        <div class="form-group">
