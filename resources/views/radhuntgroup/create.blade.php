...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Form
            <small>Rad Hunt Group Form</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <!-- /.box -->
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Rad Hunt Group Form</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                    {!! Form::open(['action' => 'RadHuntGroupController@store', 'method' => 'POST']) !!}
                        <div class="form-group">
                            {{Form::label('id', 'Rad Hunt Group Id')}}
                            {{Form::number('id', '', ['class' => 'form-control', 'placeholder' => 'Rad Hunt Group Id (Fill with number)'])}}
                        </div>
                        <div class="form-group">
                            {{Form::label('groupname', 'Rad Hunt Groupname')}}
                            {{Form::text('groupname', '', ['class' => 'form-control', 'placeholder' => 'Rad Hunt Groupname'])}}
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            {{Form::text('nasportid', '', ['class' => 'form-control', 'placeholder' => 'Nas Port Id'])}}
                        </div>
