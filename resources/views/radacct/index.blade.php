...
@section('sidebars')
    ...
    <li class="active"><a href="{{url('radacct')}}"><i class="fa fa-table"></i> <span>Rad Acct</span></a></li>
            ...
            <!-- /.box -->
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Rad Acct Table</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                    <a href="../public/radpostauth/create"><button type="button" class="btn btn-block btn-info">Add Rad Acct Data</button></a>
                        <table class="table table-bordered table-striped" id="datatable" >
                            <thead>
                                <tr>
                                    ...
                                    <th>nasporttype</th>
                                    <th>acctstarttime</th>
                                    <th>acctupdatetime</th>
                                    <th>acctstoptime</th>
                                    <th>acctinterval</th>
                                    <th>acctsessiontime</th>
                                    <th>acctauthentic</th>
                                    <th>connectinfo_start</th>
                                    <th>connectinfo_stop</th>
                                    <th>acctinputoctets</th>
                                    <th>acctoutputoctets</th>
                                    <th>calledstationid</th>
                                    <th>calingstationid</th>
        ...
        $(document).ready( function () {
            $('#datatable').DataTable({
                ...
                "columns": [
                    ...
                    { "data": "acctauthentic" },
                    { "data": "connectinfo_start" },
                    { "data": "connectinfo_stop" },
                    { "data": "acctinputoctets" },
                    { "data": "acctoutputoctets" },
                    { "data": "calledstationid" },
                    { "data": "calingstationid" },
