...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Form
            <small>Rad Group Reply Form</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <!-- /.box -->
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Rad Group Reply Form</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                    {!! Form::open(['action' => 'RadGroupReplyController@store', 'method' => 'POST']) !!}
                        <div class="form-group">
                            {{Form::label('id', 'Rad Group Reply Id')}}
                            {{Form::number('id', '', ['class' => 'form-control', 'placeholder' => 'Rad Group Reply Id (Fill with number)'])}}
                        </div>
                        <div class="form-group">
                            {{Form::label('groupname', 'Rad Reply Groupname')}}
                            {{Form::text('groupname', '', ['class' => 'form-control', 'placeholder' => 'Rad Reply Groupname'])}}
                        </div>
                        <div class="form-group">
