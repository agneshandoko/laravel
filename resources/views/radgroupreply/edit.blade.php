...
@section('sidebars')
    ...
    <li class="active"><a href="{{url('radgroupreply')}}"><i class="fa fa-table"></i> <span>Rad Group Reply</span></a></li>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Form
            <small>Rad Group Reply Edit Form</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Form</a></li>
            <li class="active">Rad Group Reply Form</li>
        </ol>
    </section>
            ...
            <!-- /.box -->
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Rad Group Reply Edit Form</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                    {!! Form::open(['action' => ['RadGroupReplyController@update', $radData->id], 'method' => 'POST']) !!}
                        <div class="form-group">
                            {{Form::label('id', 'Rad Group Reply Id')}}
                            {{Form::number('id', $radData->id, ['class' => 'form-control', 'placeholder' => 'Rad Group Reply Id (Fill with number)'])}}
                        </div>
                        <div class="form-group">
                            {{Form::label('groupname', 'Rad Reply Groupname')}}
                            {{Form::text('groupname', $radData->groupname , ['class' => 'form-control', 'placeholder' => 'Rad Reply Groupname'])}}
                        </div>
                        <div class="form-group">
