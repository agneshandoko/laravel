            ...
            <!-- /.box -->
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Rad Group Reply Table</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                    <a href="../public/radgroupreply/create"><button type="button" class="btn btn-block btn-info">Add Rad Group Reply</button></a>
